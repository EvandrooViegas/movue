//Por o background do styles.css
//Por a tag suspense no App.vue
...
movie.value = await fetch(`https://api.themoviedb.org/3/movie/${movieId}?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US`)
.then(res => res.json())
